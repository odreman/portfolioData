...
### 📊 [Visualización de Datos](data-visualization/README.md)
...
[Ver portafolio completo →](data-visualization/README.md)
...
### 📈 [Estadística para Data Science](Estadística%20para%20DS/README.md)
...
[Ver portafolio completo →](Estadística%20para%20DS/README.md)

---

### 🔧 [Preprocesamiento de Datos](Data%20Preprocessing/README.md)
...
[Ver portafolio completo →](Data%20Preprocessing/README.md)

---

### 🤖 [Machine Learning Operations (MLOps)](Machine%20Learning%20Ops/README.md)
...
[Ver portafolio completo →](Machine%20Learning%20Ops/README.md)

---

### 📈 [Predictive Analytics](Predictive%20Analytics/README.md)
...
[Ver portafolio completo →](Predictive%20Analytics/README.md)
...
[Ver portafolio completo →](Machine%20learning/README.md)
...
**Proyectos incluidos:**
1. **Clasificación de Secuencias con LSTM** - Análisis de sentimientos en reseñas de películas IMDB con 7+ iteraciones de optimización. Mejor resultado: Bidirectional LSTM (87.66% accuracy). Incluye experimentación con CNN+LSTM, Stacked LSTM, y embeddings GloVe
2. **Clasificación de Imágenes con CNN** - Serie de 4 notebooks progresivos con experimentación exhaustiva: data augmentation detallado, análisis sistemático de dropout (0.1-0.9), transfer learning con Inception V3 aplicado a perros/gatos y flores
3. **Detección de Objetos con YOLO** - Implementación de YOLOv5 entrenado durante 50 épocas en COCO128. Incluye visualización de detecciones y aplicación práctica previa en videos de Fortnite
4. **Redes Neuronales DNN** - Dos proyectos fundamentales: resolución del problema XOR (demostrando necesidad de capas ocultas) y Fashion MNIST con optimización exhaustiva (normalización, learning rate, callbacks) alcanzando 90.14% de precisión

**Tecnologías principales:** TensorFlow, Keras, PyTorch, LSTM, CNN, YOLO, OpenCV, GloVe, Inception V3, ReduceLROnPlateau, EarlyStopping

[Ver portafolio completo →](Deep%20learning/README.md)
...
- Procesamiento de secuencias con LSTM (Bidirectional, Stacked, CNN+LSTM)
- Clasificación de imágenes con CNN
- Transfer learning y fine-tuning (Inception V3, VGG, ResNet)
- Detección de objetos con YOLO (YOLOv5)
- Embeddings pre-entrenados (GloVe) y fine-tuning
- Data augmentation exhaustivo para imágenes
- Análisis de sentimientos en texto
- Normalización de datos (escalado, centrado, estandarización)
- Optimización de learning rate y callbacks (ReduceLROnPlateau, EarlyStopping)
- Regularización (Dropout, SpatialDropout1D, L2, recurrent dropout)
- Resolución de problemas no linealmente separables (XOR)
- Análisis de arquitecturas y transformación de espacios
